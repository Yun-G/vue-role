		...
		<el-card class="box-card">
			...
			<el-form :model="form" ref="form" :rules="RULES">
				...
				<el-form-item prop="password">
					<el-input @keyup.native.enter="toRegister" type="password" v-model="form.password" placeholder="密码"></el-input>
				</el-form-item>
				<el-form-item>
					<el-button :loading="btnloading" type="primary" @click="toRegister" style="width:100%">注 册</el-button>
				</el-form-item>
			</el-form>
			<p class="login"><span>已经有账号了？</span><i @click="()=>{$router.push('/login')}">去登录</i></p>
		</el-card>
